...
useEffect(()=>{
  ...
  const addStock = async () => {
    try {
      ...
      await axios.put(`http://localhost:5000/api/users/stocks`,
      // {
      //   method: 'PUT',
      // }
      {stockSymbol});
  ...
  return (
    <div className="rounded-md relative p-8 border-2 border-neutral-200">
      ...
      <button onClick={()=>{addStock()}}  style={{marginLeft:"205px",padding:"5px"}} className="btn-success">Add to watchlist</button>
        </div>
